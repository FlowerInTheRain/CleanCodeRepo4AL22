...
public class PackOpenServiceTest {
    ...
    public void shouldFndSome(){
        ...
        List<BusinessCard> newUserCards = new ArrayList<>();
        String rarity0 = CardRarityEnum.COMMON.name();
        BusinessCard cardToReturn0 = BusinessCard.createOne(1L,"1231", CardRarityEnum.COMMON, CardSpecialtyEnum.ASSASSIN, CardNameEnum.ARMAND,0,1);
        ...
        cardToReturn0 = BusinessCard.createOne(1L,"1232", CardRarityEnum.RARE, CardSpecialtyEnum.ASSASSIN, CardNameEnum.ARNAUD,0,1);
        when(cardPersistencePort.findOneCardByRarity(rarity0)).thenReturn(cardToReturn0);
        newUserCards.add(cardToReturn0);
        rarity0 = CardRarityEnum.LEGENDARY.name();
        cardToReturn0 = BusinessCard.createOne(1L,"1233", CardRarityEnum.LEGENDARY, CardSpecialtyEnum.ASSASSIN, CardNameEnum.JONATHAN,0,1);
        when(cardPersistencePort.findOneCardByRarity(rarity0)).thenReturn(cardToReturn0);
        newUserCards.add(cardToReturn0);
    ...
    public void shouldOpenSilverCardPack(){
        ...
        BusinessCard cardToReturn0 = BusinessCard.createOne(1L,"1231", CardRarityEnum.COMMON, CardSpecialtyEnum.ASSASSIN, CardNameEnum.ARMAND,0,1);
        BusinessCard cardToReturn1 = BusinessCard.createOne(1L,"1232", CardRarityEnum.COMMON, CardSpecialtyEnum.MAGE, CardNameEnum.ENZO,0,1);
        BusinessCard cardToReturn2 = BusinessCard.createOne(1L,"1233", CardRarityEnum.RARE, CardSpecialtyEnum.TANK, CardNameEnum.JONATHAN,0,1);
