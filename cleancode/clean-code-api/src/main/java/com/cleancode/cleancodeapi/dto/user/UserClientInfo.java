...
public class UserClientInfo extends UserFullName {
    ...
    protected UserClientInfo(UserFullName userFullName, String clientReference, String clientCreationDate, Address clientAddress, List<CardCollection> userCardCollectionsList) {
