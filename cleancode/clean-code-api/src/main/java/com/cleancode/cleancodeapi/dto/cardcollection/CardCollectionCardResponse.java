...
public class CardCollectionCardResponse {
    ...
    public void addXp() {
        this.xp += CardCollectionCardResponse.XP_GRANTED;
        while (this.xp >= CardCollectionCardResponse.XP_FOR_LVL_UP && this.level < CardCollectionCardResponse.LVL_MAX) {
            this.levelUp();
        }
    }

    private void levelUp() {
        this.xp -= CardCollectionCardResponse.XP_FOR_LVL_UP;
        this.level += CardCollectionCardResponse.LVL_GRANTED;
        this.armor = ((Double) (this.armor * CardCollectionCardResponse.RATIO_STAT_UPGRADE)).longValue();
        this.lifePoints = ((Double) (this.lifePoints * CardCollectionCardResponse.RATIO_STAT_UPGRADE)).longValue();
        this.power = ((Double) (this.power * CardCollectionCardResponse.RATIO_STAT_UPGRADE)).longValue();
    }
    ...
    public boolean equals(Object o) {
        ...
        CardCollectionCardResponse that = (CardCollectionCardResponse) o;
